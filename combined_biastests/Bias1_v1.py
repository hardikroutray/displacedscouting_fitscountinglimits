...
for j in range(len(ctaus)):
        ...
        # os.chdir("./mass_{}".format(mass))
        for file in glob.glob("datacard*allbinsbias_v1.txt"):
        ...
        for i in INJ:
            ...
            if mass < 3:
                ...
                T.Draw("(r-%f)/(rHiErr)>>Bias Test, injected r=%d" %(i,int(i)),"abs(rLoErr)/r > 0.01")
